document.addEventListener('DOMContentLoaded', () => {
    ...
    const totalCompleted = jsDataDiv.getAttribute('data-total-completed');
    const totalBalance = jsDataDiv.getAttribute('data-total-balance');
    const totalEarnings = jsDataDiv.getAttribute('data-total-earnings');
    const totalCompletedNum = parseInt(totalCompleted, 10);
    ...
    var optionsProfileVisit = {
        ...
        series: [{
            ...
            data: [0,0 ,0 ,0 ,0 ,0 ,0 , totalCompletedNum, 0, 0, 0, 0]
        }],
        colors: '#435ebe',
        xaxis: {
    ...
    // small charts
    var optionsEurope = {
        series: [{ name: 'series1', data: [30,40,55,48,60,62,70,68,72,75,78,80] }],
        ...
        ], axisBorder:{show:false}, axisTicks:{show:false}, labels:{show:false} },
        show: false,
